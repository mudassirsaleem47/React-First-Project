...
const Leftcontent = () => {
  return (
    <div className='h-full w-[30%] flex flex-col shrink-0 justify-between pt-20'>
        ...
        <p className='w-[90%] text-2xl text-gray-700'>Depending on customer satisfaction and access to banking products, potential target audience can be divided into three groups.</p>
        </div>
        <div className='p-0'>
